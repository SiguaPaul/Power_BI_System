    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <header className="flex-grow">
        <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center md:items-start md:justify-between">
          ...
          <div className="md:w-1/2">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 pt-20">
      ...
      <main className="bg-white">
        <div className="max-w-7xl mx-auto px-6 py-10">
          <h3 className="text-2xl font-bold text-gray-800 mb-8 bg-yellow-300 w-110 rounded-2x1">
            Información sobre Costos y Ventas
          </h3>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
            {/* Tarjeta 1 */}
            <div className="p-6 bg-gray-100 rounded-2x1 shadow h-50">
            ...
            {/* Tarjeta 2 */}
            <div className="p-6 bg-blue-50 rounded-2x1 shadow h-50">
              <h4 className="text-xl font-semibold mb-2">
                Información sobre Costos y Ventas
              </h4>
              <p className="text-gray-700">
            ...
            {/* Tarjeta 3 */}
            <div className="p-6 bg-black text-white rounded-2x1 shadow h-50">
              <h4 className="text-xl font-semibold mb-2">
                Información sobre Costos y Ventas
              </h4>
              <p>
            ...
            {/* Tarjeta 4 */}
            <div className="p-6 bg-green-50 rounded-2x1 shadow h-50">
              <h4 className="text-xl font-semibold mb-2">
                Información sobre Costos y Ventas
              </h4>
